    ...
    calculate() {
      for (let i = 0; i < 1000; i++) {
        ...
        if (this.goodList.indexOf(this.sokaku) !== -1) {
          if (this.goodList.indexOf(this.jinkaku) !== -1) {
            this.results.push({
              name:
                this.kanjis[this.random3].text + this.kanjis[this.random4].text,
              sokaku: this.sokaku,
      ...
      //   if (this.kanjis[i].number < 9) {
      //     this.results.push({
      //       text: this.kanjis[i].text,
      //       number: this.kanjis[i].number,
      //     })
      //   }
      // }
    },
